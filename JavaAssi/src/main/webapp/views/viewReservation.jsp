            ...
            <body class="d-flex flex-column min-vh-100">
                <%@ include file="_header.jsp" %>
                    <main class="container py-4 flex-grow-1">
                        ...
                        <div class="card shadow-sm mb-4">
                            <div class="card-body">
                                <form action="<%=request.getContextPath()%>/reservation" method="get"
                                    ...
                                    <div class="col-md-8">
                                        <label for="reservationNo" class="form-label fw-semibold">Reservation
                                            Number</label>
                        ...
                        <% if (searchError !=null) { %>
                            <div class="alert alert-warning"><i class="fas fa-exclamation-circle me-2"></i>
                                <%=searchError%>
                            </div>
                            <% } %>
                                ...
                                <% if (res !=null) { String sc="secondary" ; if ("CONFIRMED".equals(res.getStatus()))
                                    ...
                                    <div class="card shadow reservation-detail-card">
                                        <div class="card-header d-flex justify-content-between align-items-center">
                                            <h5 class="mb-0"><i class="fas fa-bookmark me-2"></i>Reservation: <strong
                                                    class="text-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-md-6">
                                                    <h6 class="section-label"><i class="fas fa-user me-2"></i>Guest
                                                        Information</h6>
                                                ...
                                                <div class="col-md-6">
                                                    <h6 class="section-label"><i class="fas fa-bed me-2"></i>Room
                                                        Information</h6>
                                                    <table class="table table-sm table-borderless detail-table">
                                                        <% if (res.getRoom() !=null) { %>
                                                            <tr>
                                                                <td class="text-muted fw-semibold">Room No.:</td>
                                                            ...
                                                            <tr>
                                                                <td class="text-muted fw-semibold">Rate/Night:</td>
                                                                <td>Rs.
                                                                    <%=String.format("%,.2f",res.getRoom().getRatePerNight())%>
                                                                </td>
                                                            </tr>
                                                            <% } %>
                                                    </table>
                                                ...
                                                <div class="col-md-6">
                                                    <h6 class="section-label"><i class="fas fa-receipt me-2"></i>Billing
                                                    </h6>
                                                    <table class="table table-sm table-borderless detail-table">
                                                        <tr>
                                                            <td class="text-muted fw-semibold">Total Cost:</td>
                                                            <td class="fw-bold text-success fs-5">Rs.
