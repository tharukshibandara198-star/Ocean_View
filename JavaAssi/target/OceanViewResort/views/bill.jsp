        ...
        <%@ page import="com.oceanview.model.Reservation" %>
            <%@ page import="com.oceanview.model.User" %>
                <% if (session.getAttribute("loggedInUser")==null) { response.sendRedirect(request.getContextPath()
                    ...
                    billError=(String) request.getAttribute("billError"); User currentUser=(User)
                                    ...
                                    <form action="<%= request.getContextPath() %>/bill" method="get"
                                        ...
                                        <div class="col-md-8">
                                            <label for="reservationNo" class="form-label fw-semibold">
                                                <i class="fas fa-file-invoice me-1"></i>Enter Reservation Number to
                                                Generate Bill
                                            </label>
                                            ...
                                            <% if (res !=null) { %>
                                                <div class="card shadow bill-card" id="billSection">
                                                    ...
                                                    <div class="bill-header text-center p-4">
                                                        <h2 class="mb-0"><i class="fas fa-water me-2"></i>Ocean View
                                                            Resort</h2>
                                                        <p class="mb-0 text-muted">No. 1, Beach Avenue, Galle, Sri Lanka
                                                            | Tel: +94 91 2345678</p>
                                                        <hr>
                                                    ...
                                                    <div class="card-body px-5">
                                                        ...
                                                        <div class="row mb-4">
                                                            <div class="col-6">
                                                                <p class="mb-1"><strong>Reservation No:</strong>
                                                        ...
                                                        <div class="bill-section mb-4">
                                                            ...
                                                            <table class="table table-sm table-borderless">
                                                                <tr>
                                                                    <td style="width:200px" class="text-muted">Name</td>
                                                                    <td><strong>
                                                                            <%= res.getGuestName() %>
                                                                        </strong></td>
                                                                </tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td class="text-end fw-bold">
                                                                            Rs. <%= String.format("%,.2f", res.getRoom()
                                                                                !=null ?
                                                                                res.getRoom().getRatePerNight().multiply(java.math.BigDecimal.valueOf(res.getNumberOfNights()))
                                                                                : res.getTotalCost()) %>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                        ...
                                                        <div class="text-center mt-4 text-muted">
                                                            <p>Thank you for choosing <strong>Ocean View
                                                                    Resort</strong>. We hope you enjoyed your stay!</p>
                                                            <p class="small">This is a computer-generated bill. No
                                                                signature required.</p>
                                                        </div>
                                                    </div>
                                                </div>

                                                <!-- Print / Back buttons (no-print) -->
